...
Поскольку uPlayer является автономным веб-приложением, запустить его невероятно просто:

1. **Скачайте** html-файл приложения на свой компьютер.
2. **Кликните дважды** по файлу, чтобы открыть его в любом современном браузере (Chrome, Firefox, Edge, Safari).
3. **Перетащите (Drag and drop)** ваши аудиофайлы или папки с музыкой прямо в окно браузера, чтобы начать прослушивание.
